...
def seed_hosts():
  hosts = [
    {"id": 16, "zip": "3220-435", "first_name": "Derk", "last_name": "Willows", "email": "dwillowsf@cisco.com",
     ...
     "hnt_wallet": "12n53rX6m2om5AbLswmyHwBPJY57B3wbHh"},
    {"id": 17, "first_name": "Neala", "last_name": "Connerly", "email": "nconnerlyg@sourceforge.net",
     ...
     "zip": "3220-435", "hnt_wallet": "1B7nt1gZVgwDfbuFtQf2TQzdgLnB85SJWU"},
    {"id": 18, "first_name": "Jesse", "last_name": "Trethewey", "email": "jtretheweyh@ycombinator.com",
     ...
     "zip": "37942 CEDEX 9", "hnt_wallet": "1K2nsKLh4GwJppJ85xeauyJgH88sN74cuH"},
    {"id": 19, "first_name": "Con", "last_name": "Fawley", "email": "cfawleyi@jalbum.net", "phone": "567-201-1990",
     ...
     "hnt_wallet": "15EyHpBCCRaZKP1c4qhvwn6WYL1eDz8Hr2"},
    {"id": 20, "first_name": "Dex", "last_name": "Sterricker", "email": "dsterrickerj@gov.uk", "phone": "530-636-0962",
     ...
     "hnt_wallet": "1MKqcU4yiEzSueWdGkGSyPuEcCsBHT9T17"}]
...
def seed_hotspots():
  hotspots = [
    {'net_add': "11sDK9KUao8SudAgzRzKHQT5JjvKdG7v9bUzpu6LEb85DyYuMrg", 'name': "magic_shadow_tiger"},
    {'net_add': "11fieGXr67sevi4PQKimfjBkyVLa3JgQBmiiKebqE2hVszNdXuB", 'name': "proper_mustard_yeti"},
    {'net_add': "112UgNkWKUzLEW9cdYAE9AdYmfQDSUJeJZdDQsLN6aA1x7byV7eh", 'name': "fluffy_glass_meerkat"},
